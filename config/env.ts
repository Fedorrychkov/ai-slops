const {
   ...
   * NOTIFY_GAME_MODERATION_ENABLED=1
   * NOTIFY_GAME_MODERATION_CHANNELS=all
   * NOTIFY_GAME_PENDING_ADMIN_ENABLED=1
   * NOTIFY_GAME_PENDING_ADMIN_CHANNELS=web_push
   * NOTIFY_GAME_FEEDBACK_MODERATION_ENABLED=1
   * NOTIFY_GAME_FEEDBACK_MODERATION_CHANNELS=all
   */
  ...
  NOTIFY_GAME_MODERATION_ENABLED = process.env.NOTIFY_GAME_MODERATION_ENABLED || '1',
  NOTIFY_GAME_MODERATION_CHANNELS = process.env.NOTIFY_GAME_MODERATION_CHANNELS || 'all',
  NOTIFY_GAME_PENDING_ADMIN_ENABLED = process.env.NOTIFY_GAME_PENDING_ADMIN_ENABLED || '1',
  NOTIFY_GAME_PENDING_ADMIN_CHANNELS = process.env.NOTIFY_GAME_PENDING_ADMIN_CHANNELS || 'web_push',
  NOTIFY_GAME_FEEDBACK_MODERATION_ENABLED = process.env.NOTIFY_GAME_FEEDBACK_MODERATION_ENABLED || '1',
  NOTIFY_GAME_FEEDBACK_MODERATION_CHANNELS = process.env.NOTIFY_GAME_FEEDBACK_MODERATION_CHANNELS || 'all',
...
const NOTIFICATION_CONFIG = {
  ...
  gameModerationEnabled: NOTIFY_GAME_MODERATION_ENABLED,
  gameModerationChannels: NOTIFY_GAME_MODERATION_CHANNELS,
  gamePendingAdminEnabled: NOTIFY_GAME_PENDING_ADMIN_ENABLED,
  gamePendingAdminChannels: NOTIFY_GAME_PENDING_ADMIN_CHANNELS,
  gameFeedbackModerationEnabled: NOTIFY_GAME_FEEDBACK_MODERATION_ENABLED,
  gameFeedbackModerationChannels: NOTIFY_GAME_FEEDBACK_MODERATION_CHANNELS,
}
